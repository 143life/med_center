...
from core.apps.medcenter.models.appointment import Appointment as AppointmentDTO
from core.apps.medcenter.services.base import BaseService


class ORMAppointmentService(BaseService[AppointmentFilters, Appointment, AppointmentDTO]):
	...
	def get_appointment_count(
		...
		return ORMAppointmentService.get_count(
			filters=filters
		)
