...
from core.apps.medcenter.services.specialization import ORMSpecializationService

router = Router(tags=[])

class SpecializationHandler(BaseHandler[SpecializationFilters, SpecializationSchema, ORMSpecializationService]):
